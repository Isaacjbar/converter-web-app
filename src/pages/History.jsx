            ...
            {entries.map(entry => (
              <div key={entry.id} className="relative">
                <button
                  ...
                  className={`w-full text-left p-4 pr-10 rounded-xl cursor-pointer border transition-all duration-200
                ...
                <button
                  ...
                  className="absolute top-4 right-3 text-neutral-400 hover:text-red-500 transition-colors"
                >
